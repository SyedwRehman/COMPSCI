...
#define num_neurons_layer2 20 // N2 = 40, Number of neurons for layer 2 used to create arrays for weights, activation functions and biases 
#define num_neurons_layer3 10 // N3 = 20, Number of neurons for layer 3 used to create arrays for weights, acitvation functions, and biases 
...
#define Learning_rate 0.0075  // 0 - 1, 0.01 - 0.0001, 
#define epochs 510001 // Number of times the model is ran
